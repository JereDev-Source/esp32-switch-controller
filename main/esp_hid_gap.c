...
esp_err_t esp_hid_ble_gap_adv_init(uint16_t appearance, const char *device_name)
{
    ...
    /*
     * Switch 2 controllers are discovered through Nintendo's manufacturer
     * advertisement, not by the standard HID service alone. The company ID
     * is 0x0553 (little-endian), followed by the public Pro Controller 2
     * advertisement prefix and PID 0x2069 (little-endian).
     */
    static uint8_t switch2_manufacturer_data[] = {
        0x53, 0x05, 0x01, 0x00, 0x03, 0x7E, 0x69, 0x20
    };
    ...
    esp_ble_adv_data_t ble_adv_data = {
        ...
        .manufacturer_len = sizeof(switch2_manufacturer_data),
        .p_manufacturer_data = switch2_manufacturer_data,
        .service_data_len = 0,
        .p_service_data = NULL,
        .service_uuid_len = 0,
        .p_service_uuid = NULL,
